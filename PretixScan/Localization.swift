...
struct Localization {
    ...
    struct SettingsTableViewController {
        ...
        static let ConfirmReset = NSLocalizedString("This will delete event data from the device and log you out. Do you want to continue?", comment: "")
        static let CancelReset = NSLocalizedString("Do Nothing", comment: "")
        static let ContinueReset = NSLocalizedString("Delete Everything", comment: "")
